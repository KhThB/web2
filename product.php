                ...
                <div class="col-lg-9">
                    ...
                    <div class="row align-items-center latest_product_inner">
                        <?php 
                            ...
                            $numrow = rowCount("SELECT * FROM sanpham WHERE $whereClause", $params);
                            ...
                            $products = selectAll($query, $params);
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <?php if ($current_page > 1) {
                                            ...
                                            $url = "?per_page=$item_per_page&page=$prev_page" . (isset($keyword) ? "&tim=$keyword" : "") . (isset($_GET['sort_price']) ? "&sort_price={$_GET['sort_price']}" : "");
                                        ?>
                                            <li class="page-item">
                                        ...
                                        <?php for ($num = 1; $num <= $totalpage; $num++) {
                                            $url = "?per_page=$item_per_page&page=$num" . (isset($keyword) ? "&tim=$keyword" : "") . (isset($_GET['sort_price']) ? "&sort_price={$_GET['sort_price']}" : "");
                                            if ($num != $current_page) {
                                        ...
                                        <?php if ($current_page < $totalpage - 1) {
                                            ...
                                            $url = "?per_page=$item_per_page&page=$next_page" . (isset($keyword) ? "&tim=$keyword" : "") . (isset($_GET['sort_price']) ? "&sort_price={$_GET['sort_price']}" : "");
                                        ?>
                                            <li class="page-item">
